...
<!-- ELECTRICAL Section -->
<section class="equipment-section" id="ELECTRICALSection">
  <div class="container">
    <div class="section-header d-flex justify-content-between align-items-center mb-4">
      <h2 class="section-title m-0">EXPLORE ALSO </h2>
    ...
    <div class="position-relative">
      <div class="swiper ELECTRICAL-swiper">
...
<?php include './components/shared/card.php'; ?>
      ...
      <div class="custom-navigation">
        <div class="swiper-button-prev ELECTRICAL-prev" aria-label="Previous slide"></div>
        <div class="swiper-button-next ELECTRICAL-next" aria-label="Next slide"></div>
      </div>
    </div>
  </div>
</section>