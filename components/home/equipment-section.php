...
<section class="equipment-section" id="equipmentSection">
  <div class="container">
    <div class="section-header d-flex justify-content-between align-items-center mb-4">
      ...
      <a href="#" class="show-all-link" aria-label="View all lighting equipment">
        Show All
    ...
    <div class="position-relative">
      ...
      <div class="custom-navigation">
        <div class="swiper-button-prev equipment-prev" aria-label="Previous slide"></div>
        <div class="swiper-button-next equipment-next" aria-label="Next slide"></div>
      </div>
    </div>
  </div>
</section>
